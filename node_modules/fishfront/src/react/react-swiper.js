...
module.exports = React.createClass({
    ...
    componentDidMount: async function () {
      await this.setState({
        ...
        pagination:'swiper-pagination'+uniqueNum()
      });
      this.promise = new Promise((resolve,reject)=>{
          require.ensure([],()=>{
             var Swiper = require("swiper");
             this.swiper = new Swiper('.'+this.state.swiperWrap, Object.assign({
    ...
    componentControl: async function(controlSwiper){
      await this.promise;
      await controlSwiper.promise;
      this.swiper.params.control = controlSwiper.swiper;
    },
    render: function() {
      	return React.createElement('div', {className:classname(this.state.swiperWrap,styles.container,this.props.className)},
        	React.createElement('div', {className:'swiper-wrapper'},
          		React.Children.map(this.props.children, function (child,index) {
                return React.cloneElement(child, {className:'swiper-slide'}); 
          		})
        	),
          React.createElement('div',{className:classname(this.state.pagination,'swiper-pagination')},null)
      );
    }
});
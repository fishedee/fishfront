...
export default React.createClass({
	...
	_checkPlaceHolder:function(){
		...
		if( hasImage == false && text == '' )
			self._placeholderElement.style.display = "block";
		else
			self._placeholderElement.style.display = "none";
	},
	_initEvent:function(){
		var self = this;
	...
	insertImageWithNewParagraph:function(src){
		var image = '<p><img src="'+src+'" style="max-width:100%;border-radius:10px;"></p>';
	...
	render: function() {
		return React.createElement(
			...
			React.createElement(
				'div',
				{className:classname(style.content,'needsclick'),ref:'input',autoFocus:'true',contentEditable:'true',id:this.props.id}
			),
			React.createElement(
				'div',

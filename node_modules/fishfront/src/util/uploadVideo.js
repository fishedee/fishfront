...
export default {
	...
	_uploadVideoFun:function( file , defaultOption){
		var self = this;
	...
	_uploadVideo:function( file , defaultOption ){
		var self = this;
	...
	_localVideoUpload:function(file , defaultOption){
		//构造数据
	...
	_video:function( option ){
		...
		if(defaultOption.accept)
			defaultOption.type = 'accept="video/*"';

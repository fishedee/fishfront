...
exports.default = {
	...
	isInWeixin: function isInWeixin() {
		return this.isInBrowser() && navigator.userAgent.indexOf('WindowsWechat') < 0 && navigator.userAgent.match(/MicroMessenger\/[.\d]+/);
	},
	...
	isInIosCriOS: function isInIosCriOS() {
		return this.isInIos() && navigator.userAgent.match(/CriOS\/([\d.]+)/);
	},

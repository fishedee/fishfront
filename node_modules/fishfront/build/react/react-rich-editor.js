...
exports.default = React.createClass({
	...
	_checkPlaceHolder: function _checkPlaceHolder() {
		...
		if (hasImage == false && text == '') self._placeholderElement.display = "block";else self._placeholderElement.display = "none";
	},
	...
	render: function render() {
		return React.createElement('div', { className: (0, _classnames2.default)(style.root, this.props.className), style: this.props.style }, React.createElement('div', { className: style.content, ref: 'input', autoFocus: 'true', contentEditable: 'true' }), React.createElement('div', { className: style.placeholder, ref: 'placeholder' }));
	}
});
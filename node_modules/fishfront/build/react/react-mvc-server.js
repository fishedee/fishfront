	...
	_createClass(MvcServer, [{
		...
		value: (function () {
			var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(req, resp) {
				var file, config, routerResult, ModelProvider, model, renderProps, serverHandler, i, data, DocumentHeadProvider, documentHead, html, style, result;
					...
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								//读取webpackJson
								try {
									file = _fs2.default.readFileSync(this.webpackJson, 'utf-8');
							...
							case 44:
								...
								documentHead.setWebpackJson(config);

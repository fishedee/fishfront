...
module.exports = React.createClass({
  ...
  componentDidMount: function componentDidMount() {
    ...
    require.ensure([], function () {
      ...
      _this.swiper = new Swiper('.' + styles.container, Object.assign({
  ...
  componentDidUpdate: function componentDidUpdate(prevProps, propsState) {
    ...
    if (prevProps.children.size != this.props.children.size) {
      require.ensure([], function () {
        var Swiper = require("swiper");
        _this2.swiper = new Swiper('.' + styles.container, Object.assign({
          paginationClickable: true,
          pagination: '.swiper-pagination'
        }, _this2.props));
      });
  ...
  render: function render() {
    return React.createElement('div', { className: (0, _classnames2.default)(styles.container, this.props.className) }, React.createElement('div', { className: 'swiper-wrapper' }, React.Children.map(this.props.children, function (child, index) {

...
var DocumentHead = (function () {
	...
	_createClass(DocumentHead, [{
		...
		key: '_renderSelfArray',
		value: function _renderSelfArray(target, tag) {
			var meta = [];
			for (var i in target) {
				var singleMeta = '<' + tag + ' ' + this._renderObject(target[i]) + '/>';
				meta.push(singleMeta);
			}
			return meta.join("\n");
		}
		...
		value: function renderMetaString() {
			return this._renderSelfArray(this.header.meta, 'meta');
		}
	}, {
		...
		key: 'getWebpackJson',
		value: function getWebpackJson() {
			return this.webpackJson;
		}
	}]);

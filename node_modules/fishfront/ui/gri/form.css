...
.icon-pw-high,.icon-pw-mid ,.icon-pw-low{background:url(./img/pw-bg.png) no-repeat; width:68px; height: 22px; display: inline-block;}
...
.radio-box{display:inline-block;_display:inline; zoom:1;font-size:14px;_font-family:"宋体";
...
.radio-box{display:inline-block;_display:inline; zoom:1;font-size:14px;_font-family:"宋体";padding:0 10px;vertical-align:middle; margin-right:9px;

...
.icon-confirm,.icon-confirm-m ,.icon-confirm-s{ background: url(./img/element.png) no-repeat 0 0; _background: url(./img/element-ie.png) no-repeat 0 0;vertical-align: middle; }
...
/*银行展示*/
.box-chooce-bank{margin: 0 auto; font:12px/1.4  "微软雅黑","宋体" ,Tahoma; color: #666;}
 .mod-bank {padding-bottom:10px; font:12px/1.4  "微软雅黑","宋体" ,Tahoma; color: #666;}
...
.icon-search2 { width: 15px; height: 15px; font-size: 0; display: inline-block; font-size: 0; background: url(./img/icon-search.png) no-repeat 0 0; }

...
describe('List', function () {
  ...
  var names = _immutable2.default.fromJS(array);
  ...
  describe('number of rendered children', function () {
    ...
    it('should not render more children than available if the list is not filled', function () {
      var rendered = (0, _reactDom.findDOMNode)((0, _TestUtils.render)(getMarkup({ rowCount: 5 })));
  ...
  describe('scrollToIndex', function () {
    it('should scroll to the top', function () {
      var rendered = (0, _reactDom.findDOMNode)((0, _TestUtils.render)(getMarkup({ scrollToIndex: 0 })));
      expect(rendered.textContent).toContain('Name 0');
    });

    it('should scroll down to the middle', function () {
      var rendered = (0, _reactDom.findDOMNode)((0, _TestUtils.render)(getMarkup({ scrollToIndex: 49 })));
    ...
    it('should scroll to the bottom', function () {
      var rendered = (0, _reactDom.findDOMNode)((0, _TestUtils.render)(getMarkup({ scrollToIndex: 99 })));
  ...
  describe('property updates', function () {
    it('should update :scrollToIndex position when :rowHeight changes', function () {
      var rendered = (0, _reactDom.findDOMNode)((0, _TestUtils.render)(getMarkup({ scrollToIndex: 50 })));
      expect(rendered.textContent).toContain('Name 50');
      // Making rows taller pushes name off/beyond the scrolled area
      rendered = (0, _reactDom.findDOMNode)((0, _TestUtils.render)(getMarkup({ scrollToIndex: 50, rowHeight: 20 })));
      expect(rendered.textContent).toContain('Name 50');
    });
    ...
    it('should update :scrollToIndex position when :height changes', function () {
      ...
      rendered = (0, _reactDom.findDOMNode)((0, _TestUtils.render)(getMarkup({ scrollToIndex: 50, height: 20 })));
      expect(rendered.textContent).toContain('Name 50');
    });
    ...
    it('should update :scrollToIndex position when :scrollToIndex changes', function () {
      ...
      rendered = (0, _reactDom.findDOMNode)((0, _TestUtils.render)(getMarkup({ scrollToIndex: 50 })));
      expect(rendered.textContent).toContain('Name 50');
    });

    it('should update scroll position if size shrinks smaller than the current scroll', function () {
      (0, _reactDom.findDOMNode)((0, _TestUtils.render)(getMarkup({ scrollToIndex: 500 })));
      (0, _reactDom.findDOMNode)((0, _TestUtils.render)(getMarkup()));
      var rendered = (0, _reactDom.findDOMNode)((0, _TestUtils.render)(getMarkup({ scrollToIndex: 500, rowCount: 10 })));
  ...
  describe('onRowsRendered', function () {
    ...
    it('should not call :onRowsRendered unless the start or stop indices have changed', function () {
      ...
      (0, _reactDom.findDOMNode)((0, _TestUtils.render)(getMarkup({ onRowsRendered: onRowsRendered })));
  ...
  describe('styles, classNames, and ids', function () {
    ...
    it('should use a custom :className if specified', function () {
      var node = (0, _reactDom.findDOMNode)((0, _TestUtils.render)(getMarkup({ className: 'foo' })));
  ...
  describe('onScroll', function () {
    ...
    it('should trigger callback when component scrolls', function () {
      ...
      _reactAddonsTestUtils.Simulate.scroll((0, _reactDom.findDOMNode)(rendered), { target: target });
  ...
  describe('forceUpdateGrid', function () {
    it('should refresh inner Grid content when called', function () {
      ...
      var component = (0, _TestUtils.render)(getMarkup({ rowRenderer: rowRenderer }));
  ...
  it('should relay the Grid :parent param to the :rowRenderer', function () {
    ...
    (0, _reactDom.findDOMNode)((0, _TestUtils.render)(getMarkup({ rowRenderer: rowRenderer })));

...
<html lang="en">
<head>
    <title>Code coverage report for src/decorator.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> decorator.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>24/38</span>
      </div>
      <div class='fl pad1y space-right2'>
...
var getDisplayName = function getDisplayName(WrappedComponent) {
  return WrappedComponent.displayName || WrappedComponent.name || <span class="branch-2 cbranch-no" title="branch not covered" >'Component';</span>
};
&nbsp;
exports.default = function () {
  var options = arguments.length &lt;= 0 || arguments[0] === undefined ? <span class="branch-0 cbranch-no" title="branch not covered" >{} </span>: arguments[0];
